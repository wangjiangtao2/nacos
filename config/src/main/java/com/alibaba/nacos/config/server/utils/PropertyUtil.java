...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private static boolean isUsePostgreSql = false;
    ...
    private void loadSetting() {
        try {
            ...
            setIsUsePostgreSql("postgresql".equalsIgnoreCase(platform));
    ...
    public static boolean isUsePostgreSql() {
        return isUsePostgreSql;
    }

    public static void setIsUsePostgreSql(boolean isUsePostgreSql) {
        PropertyUtil.isUsePostgreSql = isUsePostgreSql;
    }
}
